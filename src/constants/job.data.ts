...
export const jobs: Job[] = [
  {
    ...
    prompt: `한화생명의 신규사원 모집에 지원하려고 합니다.
...
위 정보를 바탕으로 지원서를 작성하는 데 도움이 되는 프롬프트를 생성해주세요.`,
  },
  {
    ...
    prompt: `네이버의 백엔드 개발자 모집에 지원하려고 합니다.
...
위 정보를 바탕으로 지원서를 작성하는 데 도움이 되는 프롬프트를 생성해주세요.`,
  },
  {
    ...
    prompt: `현대오토에버의 자율주행 시스템 개발에 지원하려고 합니다.
...
위 정보를 바탕으로 지원서를 작성하는 데 도움이 되는 프롬프트를 생성해주세요.`,
  },
  {
    ...
    prompt: `삼성전자의 AI 엔지니어 채용에 지원하려고 합니다.
...
위 정보를 바탕으로 지원서를 작성하는 데 도움이 되는 프롬프트를 생성해주세요.`,
  },
  {
    ...
    prompt: `LG전자의 배터리 연구원 모집에 지원하려고 합니다.
...
위 정보를 바탕으로 지원서를 작성하는 데 도움이 되는 프롬프트를 생성해주세요.`,
  },
  {
    ...
    prompt: `카카오뱅크의 프론트엔드 개발자에 지원하려고 합니다.
