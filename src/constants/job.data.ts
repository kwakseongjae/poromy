...
export const jobs: Job[] = [
  {
    ...
    jobTitle: '신규사원 모집',
    conditions: ['신입', '대졸', '서울'],
    positionDescription: '한화생명에서 신규사원을 모집합니다.',
    mainTask: '신규사원을 모집합니다.',
    qualifications: [
  ...
  },
  {
    ...
    positionDescription: '네이버에서 백엔드 개발자를 모집합니다.',
    mainTask: '백엔드 개발자를 모집합니다.',
    qualifications: [
  ...
  },
  {
    ...
    positionDescription:
      '현대오토에버에서 자율주행 시스템 개발자를 모집합니다.',
    mainTask: '자율주행 시스템 개발자를 모집합니다.',
    qualifications: [
  ...
  },
  {
    ...
    jobTitle: 'AI 엔지니어 채용',
    conditions: ['신입/경력', '수원'],
    positionDescription: '삼성전자에서 AI 엔지니어를 모집합니다.',
    mainTask: 'AI 엔지니어를 모집합니다.',
    qualifications: [
      '컴퓨터공학/인공지능 관련 학사 이상',
  ...
  },
  {
    ...
    positionDescription: 'LG전자에서 배터리 연구원을 모집합니다.',
    mainTask: '배터리 연구원을 모집합니다.',
    qualifications: [
  ...
  },
  {
    ...
    positionDescription: '카카오뱅크에서 프론트엔드 개발자를 모집합니다.',
    mainTask: '프론트엔드 개발자를 모집합니다.',
    qualifications: [
      '3년 이상의 프론트엔드 개발 경험',
